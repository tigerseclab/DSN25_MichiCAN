...
void state_machine_run(uint8_t value) {
  ...
  if (len == 10 && state == 1312) {
    start_counterattack = true;
    return;
  }
  if (len == 10 && state == 1314) {
    start_counterattack = true;
    return;
  }
  ...
  if (len == 10 && state == 1616) {
    start_counterattack = true;
    return;
  }
  if (len == 10 && state == 1618) {
    start_counterattack = true;
    return;
  }
  ...
  if (len == 11 && state == 1040) {
    start_counterattack = true;
    return;
  }
  if (len == 11 && state == 1041) {
    start_counterattack = true;
    return;
  }
  ...
  if (len == 11 && state == 1376) {
    start_counterattack = true;
    return;
  }
  if (len == 11 && state == 1377) {
    start_counterattack = true;
    return;
  }
  if (len == 11 && state == 1380) {
    start_counterattack = true;
    return;
  }
  if (len == 11 && state == 1381) {
    start_counterattack = true;
    return;
  }
  ...
  if (len == 11 && state == 1632) {
    start_counterattack = true;
    return;
  }
  if (len == 11 && state == 1633) {
    start_counterattack = true;
    return;
  }
  if (len == 11 && state == 1648) {
    start_counterattack = true;
    return;
  }
  if (len == 11 && state == 1649) {
    start_counterattack = true;
    return;
  }
  ...
  if (len == 11 && state == 1920) {
    start_counterattack = true;
    return;
  }
  if (len == 11 && state == 1921) {
    start_counterattack = true;
    return;
  }
  ...
  if (len == 11 && state == 1928) {
    start_counterattack = true;
    return;
  }
  if (len == 11 && state == 1929) {
    start_counterattack = true;
    return;
  }
