...
// using ECU CAN IDs: ['0x41', '0x42', '0x47', '0x48', '0x49', '0x4a', '0x4b', '0x4c', '0x5a', '0x5c', '0x5d', '0x76', '0x77', '0x7a', '0x7d', '0x82', '0x83', '0x84', '0x85', '0x86', '0x87', '0x91', '0x92', '0x139', '0x140', '0x14a', '0x14b', '0x156', '0x163', '0x165', '0x166', '0x167', '0x168', '0x169', '0x170', '0x171', '0x172', '0x173', '0x174', '0x175', '0x178', '0x179', '0x17a', '0x17b', '0x17c', '0x17d', '0x17f', '0x180', '0x185', '0x186', '0x200', '0x202', '0x204', '0x20a', '0x213', '0x214', '0x216', '0x217', '0x230', '0x231', '0x23a', '0x23c', '0x23d', '0x242', '0x24a', '0x24b', '0x24c', '0x25a', '0x25b', '0x25c', '0x261', '0x262', '0x2e4', '0x2ec', '0x2f1', '0x312', '0x326', '0x331', '0x332', '0x333', '0x334', '0x336', '0x344', '0x352', '0x35e', '0x365', '0x366', '0x367', '0x368', '0x369', '0x37b', '0x386', '0x38d', '0x3a8', '0x3aa', '0x3ab', '0x3b3', '0x3b4', '0x3b5', '0x3b6', '0x3b7', '0x3b8', '0x3c3', '0x3c7', '0x3c9', '0x3da', '0x3dd', '0x3e0', '0x3e1', '0x3e2', '0x3e3', '0x3ea', '0x3eb', '0x40a', '0x40c', '0x410', '0x411', '0x415', '0x416', '0x41c', '0x41d', '0x421', '0x42c', '0x42d', '0x42f', '0x430', '0x434', '0x435', '0x436', '0x439', '0x43c', '0x43d', '0x43e', '0x440', '0x446', '0x447', '0x455', '0x456', '0x465', '0x466', '0x467', '0x471', '0x472', '0x473', '0x474', '0x475', '0x476', '0x477', '0x482', '0x483', '0x484', '0x485', '0x486', '0x488', '0x4b0', '0x581', '0x595', '0x59e', '0x5a0', '0x5a2', '0x5a5', '0x5b2', '0x5ba', '0x5e2', '0x5f2', '0x68c', '0x68d', '0x68e', '0x68f', '0x6a0', '0x6a1', '0x6a4', '0x6a5', '0x6a6', '0x6a7', '0x703', '0x70b', '0x716', '0x71e', '0x723', '0x726', '0x72b', '0x72e', '0x734', '0x736', '0x73c', '0x73e', '0x746', '0x74e', '0x750', '0x758', '0x7a1', '0x7a9', '0x7c7', '0x7cf', '0x7d0', '0x7d8', '0x7df', '0x7e0', '0x7e1', '0x7e2', '0x7e4', '0x7e6', '0x7e8', '0x7e9', '0x7ea', '0x7ec', '0x7ee']
// built for ECU bus ID: 0x7ee
void state_machine_run(uint8_t value) {
  ...
  if (len == 10 && state == 1038) {
    start_counterattack = true;
    return;
  }
  if (len == 10 && state == 1042) {
    start_counterattack = true;
    return;
  }
  ...
  if (len == 10 && state == 1050) {
    start_counterattack = true;
    return;
  }
  if (len == 10 && state == 1054) {
    start_counterattack = true;
    return;
  }
  ...
  if (len == 10 && state == 1144) {
    start_counterattack = true;
    return;
  }
  if (len == 10 && state == 1152) {
    start_counterattack = true;
    return;
  }
  ...
  if (len == 10 && state == 1874) {
    start_counterattack = true;
    return;
  }
  if (len == 10 && state == 1882) {
    start_counterattack = true;
    return;
  }
  ...
  if (len == 11 && state == 1136) {
    start_counterattack = true;
    return;
  }
  if (len == 11 && state == 1146) {
    start_counterattack = true;
    return;
  }
  if (len == 11 && state == 1147) {
    start_counterattack = true;
    return;
  }
  if (len == 11 && state == 1159) {
    start_counterattack = true;
    return;
  }
  if (len == 11 && state == 1161) {
    start_counterattack = true;
    return;
  }
  ...
  if (len == 11 && state == 1444) {
    start_counterattack = true;
    return;
  }
  if (len == 11 && state == 1446) {
    start_counterattack = true;
    return;
  }
  if (len == 11 && state == 1447) {
    start_counterattack = true;
    return;
  }
  ...
  if (len == 11 && state == 1794) {
    start_counterattack = true;
    return;
  }
  if (len == 11 && state == 1802) {
    start_counterattack = true;
    return;
  }
  ...
  if (len == 11 && state == 1873) {
    start_counterattack = true;
    return;
  }
  if (len == 11 && state == 1881) {
    start_counterattack = true;
    return;
  }
  ...
  if (len == 11 && state == 1931) {
    start_counterattack = true;
    return;
  }
  if (len == 11 && state == 1952) {
    start_counterattack = true;
    return;
  }
  if (len == 11 && state == 1954) {
    start_counterattack = true;
    return;
  }
  if (len == 11 && state == 1955) {
    start_counterattack = true;
    return;
  }
  if (len == 11 && state == 1960) {
    start_counterattack = true;
    return;
  }
  ...
  if (len == 11 && state == 2019) {
    start_counterattack = true;
    return;
  }
  if (len == 11 && state == 2021) {
    start_counterattack = true;
    return;
  }
  if (len == 11 && state == 2023) {
    start_counterattack = true;
    return;
  }
  ...
  if (len == 11 && state == 2029) {
    start_counterattack = true;
    return;
  }
  if (len == 11 && state == 2031) {
    start_counterattack = true;
    return;
  }
